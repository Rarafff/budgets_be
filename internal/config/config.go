...
func FromEnv() (Config, error) {
	cfg := Config{
		...
		OpenRouterPrimaryModel:  envOrDefault("OPENROUTER_PRIMARY_MODEL", "inclusionai/ling-3.0-flash-fin:free"),
		OpenRouterFallbackModel: envOrDefault("OPENROUTER_FALLBACK_MODEL", "nvidia/nemotron-3.5-lightning:free"),
		OpenRouterCheapModel:    envOrDefault("OPENROUTER_CHEAP_MODEL", "nvidia/nemotron-3.5-lightning:free"),
		OpenRouterReceiptModel:  envOrDefault("OPENROUTER_RECEIPT_MODEL", "inclusionai/ling-3.0-flash-vl:free"),
